...
export const AppStateSchema = z.object({
  ...
  turni: z.array(SessioneProduzioneSchema).optional(),
  sessioni: z.array(LavorazioneSchema).optional(),
  ...
  prodottiGrezzi: z.array(z.object({ id: z.string(), codice: z.string(), nome: z.string(), categorie: z.array(z.string()), calibri: z.array(z.string()), attivo: z.boolean().optional() }).merge(AuditFieldsSchema)).optional(),
  prodotti: z.array(z.object({ id: z.string(), codice: z.string(), nome: z.string(), categorie: z.array(z.string()), calibri: z.array(z.string()), attivo: z.boolean().optional() }).merge(AuditFieldsSchema)).optional(),
  ...
  varieta: z.array(z.object({ id: z.string(), prodottoId: z.string(), codice: z.string(), nome: z.string(), categoria: z.string().optional(), tipologiaId: z.string().optional(), attiva: z.boolean().optional() }).merge(AuditFieldsSchema)),
  articoli: z.array(z.object({ id: z.string(), codice: z.string(), nome: z.string(), prodottoId: z.string().optional(), varietaId: z.string().optional(), categoria: z.string().optional(), tipologiaId: z.string().optional(), pesoColloTeorico: z.number(), tipoPeso: z.enum(['EGALIZZATO', 'USCENTE']), attivo: z.boolean().optional() }).merge(AuditFieldsSchema)),
