...
export const AppStateSchema = z.object({
  ...
  prodotti: z.array(z.object({ id: z.string(), codice: z.string(), nome: z.string(), categorie: z.array(z.string()).optional(), calibri: z.array(z.string()).optional(), attivo: z.boolean().optional() }).merge(AuditFieldsSchema)).optional(),
