...
export class LocalStorageMasterDataRepository implements IMasterDataRepository {
  ...
  async getProdotti(): Promise<ProdottoGrezzo[]> { return readState().prodottiGrezzi; }
  ...
  async updateProdotti(prodotti: ProdottoGrezzo[]): Promise<void> { const s = readState(); s.prodottiGrezzi = prodotti; writeState(s); }
